...
Codex を一回限りの指示実行ではなく、段階的な実行モデルで動かせるようにし、実装前に経路を選ぶ `factory-router` も加えます。
...
3. 問題の明確化
4. 実行計画
5. repo-local agents で実装
6. 構造化された review でゲート
7. 実行時検証
8. release notes とドキュメント更新
9. retro の記録
